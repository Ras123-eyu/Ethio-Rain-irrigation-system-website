...
export const products = [
  {
    ...
    category: 'drip',
    icon: Droplets,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSv8LIWF5nRvyGgg_jQfg-g-JjQUXKC-5-mGQ&s',
    badge: 'Standard',
  ...
  },
  {
    ...
    category: 'drip',
    icon: Pipette,
    image: 'https://www.damsagri.com/wp-content/uploads/2023/06/Drip-Irrigation-Online.webp',
    badge: 'Customizable',
  ...
  },
  {
    ...
    category: 'drip',
    icon: Droplets,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7v6u4JkHCft9tRbA61LqnF4Y8vQxUzo-zfQ&s',
    badge: 'Efficient',
  ...
  },
  {
    ...
    category: 'drip',
    icon: Droplets,
    image: 'https://momentindustry.com/urun/tmb/p1hhelran4nqr1f1hqvc1c1hro1.jpg',
  ...
  {
    id: 'fixed-sprinkler-system',
    name: 'Fixed Sprinkler System',
    category: 'sprinkler',
    icon: Waves,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQY7GH-qGL1BRWj-3MWqSskw0saGazlOCo_iA&s',
    badge: 'Popular',
    shortDesc: 'Permanent or semi-permanent sprinkler systems installed with fixed piping. Compatible with gun, impact, and micro sprinklers.',
    specs: ['Application: Large fields & orchards', 'Sprinkler Types: Gun, Impact, Micro', 'Installation: Permanent/Semi-permanent', 'High Uniformity'],
  },
  {
    id: 'hand-drag-sprinkler-system',
    name: 'Hand Drag Sprinkler System',
    category: 'sprinkler',
    icon: Sprout,
    image: 'https://afdj.com.au/wp-content/uploads/2021/11/Flexidrag-hose-the-new-force-in-irrigation-replace-large.jpg',
    badge: 'Flexible',
    shortDesc: 'Portable sprinkler systems connected to flexible hoses that can be dragged manually across the field. Uses gun, impact, or micro sprinklers.',
    specs: ['Application: Variable field shapes', 'Sprinkler Types: Gun, Impact, Micro', 'Installation: Portable/Manual move', 'Cost-Effective'],
  },
  {
    id: 'rain-gun-sprinkler',
    name: 'Rain Gun Sprinkler',
    category: 'sprinkler',
    icon: Waves,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjXwmSu8btFwbbsknp6nJU-jVBOAgCR43EAw&s',
    badge: 'High Volume',
    shortDesc: 'High-pressure, large-volume rain guns for expansive coverage in both fixed and hand drag systems.',
    specs: ['Radius: 30–60m', 'Flow rate: 10–50 m³/h', 'Rotation: Adjustable arc', 'Durable metal/plastic build'],
  },
  {
    id: 'impact-sprinkler',
    ...
    category: 'sprinkler',
    icon: Waves,
    image: 'https://shop.landwater.com.au/cdn/shop/products/nelson-75-series-sr75-irrigation-big-gun-sprinkler-part-circle_700x700.jpg?v=1659933458',
    badge: 'Standard',
    shortDesc: 'Full-circle brass/plastic impact sprinkler with adjustable radius for medium to large field coverage.',
  ...
  },
  {
    ...
    category: 'sprinkler',
    icon: Sprout,
    image: 'https://www.damsagri.com/wp-content/uploads/2023/06/01-9-1536x10971-1.webp',
    badge: 'Precision',
    shortDesc: 'Low-volume micro sprinklers designed for under-tree irrigation in orchards and greenhouses.',
    specs: ['Radius: 1–5m', 'Flow rate: 20–150 L/h', 'Low pressure operation', 'Fine droplet size'],
  },
  {
