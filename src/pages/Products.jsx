              ...
              return (
                ...
                >
                  ...
                  <div className="relative overflow-hidden h-52">
                    ...
                    {/* Badge */}
                    {product.badge && (
                      <span className={`absolute top-4 left-4 text-[10px] font-black uppercase tracking-[0.15em] px-3 py-1.5 rounded-full backdrop-blur-md shadow-lg ${
                    ...
                    {/* Stock indicator */}
                    <div className={`absolute top-4 right-4 flex items-center gap-1.5 text-[9px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full backdrop-blur-md ${
                      product.inStock
          ...
          >
            ...
            <div className="relative h-72 md:h-80 overflow-hidden rounded-t-4xl">
              ...
              {selectedProduct.badge && (
                <span className={`absolute top-6 left-6 text-[10px] font-black uppercase tracking-[0.15em] px-3 py-1.5 rounded-full backdrop-blur-md ${
                  selectedProduct.badge === 'Best Seller' ? 'bg-amber-500/90 text-white' :
              ...
              <div className="absolute bottom-6 left-6">
                <div className="flex items-center gap-3 mb-2">
                  <div className={`flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full ${
